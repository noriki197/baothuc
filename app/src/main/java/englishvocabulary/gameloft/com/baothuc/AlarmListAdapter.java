...
public class AlarmListAdapter extends BaseAdapter{
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            viewholder.txtTime = view.findViewById(R.id.alarm_item_time);
            viewholder.txtName = view.findViewById(R.id.alarm_item_name);
            viewholder.btnToggle = view.findViewById(R.id.alarm_item_toogle);
            viewholder.txtDayofweek = view.findViewById(R.id.alarm_item_dayofweek);
